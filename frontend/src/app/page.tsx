    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20">
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <Typewriter
            texts={["Come", "to", "Jesus", "Fellowship", "International"]}
            className="block text-2xl text-blue-600 font-light tracking-wide"
          />

          <p className="text-base text-black max-w-xl font-light mx-auto leading-relaxed transition-all duration-500 ease-in-out">
            We are a family-oriented community committed to serving God and each
            other. Join us as we worship together and grow in our relationship
            with Christ.
          </p>
        ...
        <div className="mt-32 font-light max-w-4xl w-full grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 text-center transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 bg-white cursor-default rounded-lg">
            <h3 className="text-lg font-normal mb-4 text-black transition-colors duration-300">
              Our Mission
            </h3>
            <p className="text-gray-600 text-sm transition-colors duration-300">
              To spread the love of Christ and serve our community with
          ...
          <div className="p-8 text-center transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 bg-white cursor-default rounded-lg">
            ...
            <p className="text-gray-600 text-sm transition-colors duration-300">
              Building meaningful relationships and supporting one another in
              faith.
            </p>
          </div>
              ...
              <div className="text-left space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm font-light">
                    Bus stop: Rieu, line 5, 11 and 25
                  </p>
                  <p className="text-gray-500 text-sm font-light">
                    Tram stop: Amandolier, line 12 and 15 (~8 min walk)
                  </p>
                </div>
