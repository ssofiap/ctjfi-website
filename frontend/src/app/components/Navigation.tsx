  ...
  return (
    <nav className="w-full bg-white sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="relative z-50 flex font-light items-center justify-between md:justify-center gap-8">
          ...
          <button
            type="button"
            className={`hamburger hamburger--spring relative z-50 md:hidden ${isMenuOpen ? 'is-active' : ''}`}
          ...
          <div
            ...
            className=
              {`
                ...
                fixed inset-0 z-30 flex-col justify-between
                border-t border-gray-200 bg-white
                px-6 py-6 shadow-sm
                md:static md:min-h-0 md:flex md:flex-row
          ...
          <Link
            ...
            className="
              ...
              text-base font-light text-xl
              transition-all duration-300 ease-in-out
              hover:text-blue-600
              md:w-auto md:px-0 md:py-0
              md:text-xs md:font-normal
              md:hover:bg-transparent md:hover:text-blue-600
              md:hover:scale-105">
            Sermons
          </Link>
